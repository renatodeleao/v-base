...
/* harmony default export */ var VEyevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    $_static: function $_static() {
      ...
      return !!((_this$manager = this.manager) === null || _this$manager === void 0 ? void 0 : _this$manager.static);
    },
...
var toArrayModel = function toArrayModel(value) {
...
/* harmony default export */ var VEyeManagervue_type_script_lang_js_ = ({
  ...
  computed: {
    $_modelValueProxy: {
      get: function get() {
        return this.active ? toArrayModel(this.active) : toArrayModel(this.modelValueInternal);
      },
  ...
  methods: {
    syncModelValue: function syncModelValue(newVal) {
      ...
      var emitValue = this.multiple ? newVal : !newVal.length ? null : newVal[newVal.length - 1];
